...
Lemma sim_store_race_steps_failure
      R
      st1_src lc1_src sc1_src mem1_src
      (SIM: @sim_store_race R st1_src lc1_src sc1_src mem1_src):
  Thread.steps_failure (Thread.mk (lang (() * R)%type) st1_src lc1_src sc1_src mem1_src).
Proof.
  unfold Thread.steps_failure.
